  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBuilder" aria-labelledby="offcanvasBuilderLabel">
    ...
    <div class="offcanvas-body">
      ...
      <p>Check out all <a href="javascript:void(0)">Layout Options here</a></p>
  ...
  <div class="d-none js-build-layouts" style="display:none">
              ...
              <ul class="navbar-nav">
                ...
                <li class="hs-has-sub-menu nav-item">
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="dashboardsMegaMenu" style="min-width: 14rem;">
                    <a class="dropdown-item active" href="javascript:void(0)">Default</a>
                    <a class="dropdown-item " href="javascript:void(0)">Alternative</a>
                  </div>
                  <!-- End Mega Menu -->
                </li>
                <!-- End Dashboards -->
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                    ...
                    <div class="hs-has-sub-menu nav-item">
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="usersMegaMenu" style="min-width: 14rem;">
                        ...
                        <a class="dropdown-item " href="javascript:void(0)">Leaderboard</a>
                        <a class="dropdown-item " href="javascript:void(0)">Add User <span class="badge bg-info rounded-pill ms-1">Hot</span></a>
                      </div>
                    </div>
                    <!-- End Users -->
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="ecommerceMegaMenu" style="min-width: 14rem;">
                        ...
                        <div class="hs-has-sub-menu nav-item">
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="productsMegaMenu" style="min-width: 14rem;">
                            ...
                            <a class="dropdown-item " href="javascript:void(0)">Product Details</a>
                            <a class="dropdown-item " href="javascript:void(0)">Add Product</a>
                          </div>
                        </div>
                        <!-- End Products -->
                        ...
                        <div class="hs-has-sub-menu nav-item">
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="ordersMegaMenu" style="min-width: 14rem;">
                            ...
                            <a class="dropdown-item " href="javascript:void(0)">Order Details</a>
                          </div>
                        </div>
                        <!-- End Products -->
                        ...
                        <div class="hs-has-sub-menu nav-item">
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="customersMegaMenu" style="min-width: 14rem;">
                            ...
                            <a class="dropdown-item " href="javascript:void(0)">Customer Details</a>
                            <a class="dropdown-item " href="javascript:void(0)">Add Customers</a>
                          </div>
                        </div>
                        <!-- End Customers -->

                        <a class="dropdown-item " href="javascript:void(0)">Referrals</a>
                        <a class="dropdown-item " href="javascript:void(0)">Manage Reviews</a>
                        <a class="dropdown-item " href="javascript:void(0)">Checkout</a>
                      </div>
                    </div>
                    <!-- End E-commerce -->
                    ...
                    <div class="hs-has-sub-menu nav-item">
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="projectMegaMenu" style="min-width: 14rem;">
                        <a class="dropdown-item " href="javascript:void(0)">Overview</a>
                        <a class="dropdown-item " href="javascript:void(0)">Files</a>
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="authenticationMegaMenu" style="min-width: 14rem;">
                        ...
                        <div class="hs-has-sub-menu nav-item">
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="loginMegaMenu" style="min-width: 14rem;">
                            ...
                            <a class="dropdown-item " href="javascript:void(0)">Cover</a>
                          </div>
                        </div>
                        <!-- End Log In -->
                        ...
                        <a class="dropdown-item " href="javascript:void(0)">Error 500</a>
                      </div>
                    </div>
                    <!-- End Authentication -->

                    <a class="dropdown-item " href="javascript:void(0)" data-placement="left">API Keys</a>
                    <a class="dropdown-item " href="javascript:void(0)" data-placement="left">Welcome Page</a>
                    <a class="dropdown-item " href="javascript:void(0)" data-placement="left">Landing Page <span class="badge bg-info rounded-pill ms-1">New</span></a>
                  </div>
                  <!-- End Mega Menu -->
                </li>
                <!-- End Pages -->
                ...
                <li class="hs-has-sub-menu nav-item">
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="appsMegaMenu" style="min-width: 14rem;">
                    <a class="dropdown-item " href="javascript:void(0)">Kanban</a>
                    <a class="dropdown-item " href="javascript:void(0)">Calendar</a>
                    <a class="dropdown-item " href="javascript:void(0)">Invoice Generator</a>
