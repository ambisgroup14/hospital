...
<main id="content" role="main" class="main">
     ...
     <div>
        <div class="row align-items-end mb-3">
          ...
          <div class="col-sm-auto">
            <a class="btn btn-primary" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".exampleModalCreate">
          ...
          <table id="datatable" class="table table-borderless table-thead-bordered card-table" data-hs-datatables-options='{
            ...
            <?php
              ...
              <tr>
                ...
                <td>
                <div class="btn-group" role="group">
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".exampleModal" onclick="deleteMaster('department','depId','<?php echo $row['depId'] ?>','<?php echo $row['depName'] ?>','depSta')">
  ...
  <div class="modal fade exampleModalCreate" id="full-width-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">      
        <div class="modal-body">
        <form class="card-body" id="insertData" name="insertData" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-4">                        
  ...
  <div class="modal fade exampleModalCenter" id="full-width-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">      
        <div class="modal-body">
        <form class="card-body" id="updateData" name="updateData" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-4">                        
